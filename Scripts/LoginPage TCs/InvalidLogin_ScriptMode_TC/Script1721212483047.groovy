...
WebUI.setText(findTestObject('Object Repository/LoginPage_Objects/New Folder/loginPassword_inputField'), "wrongpwd")
WebUI.click(findTestObject("Object Repository/LoginPage_Objects/New Folder/login_btn"))
WebUI.verifyElementPresent(findTestObject('Object Repository/LoginPage_Objects/New Folder/p_Invalid credentials'), 0)
