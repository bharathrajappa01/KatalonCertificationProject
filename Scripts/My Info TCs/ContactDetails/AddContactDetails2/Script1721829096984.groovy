...
WebUI.refresh()
//WebUI.click(findTestObject('Object Repository/MyInfo_Objects/ContactDetails/TelephoneSection/input_Home_oxd-input oxd-input--active'))
...
WebUI.setText(findTestObject('Object Repository/MyInfo_Objects/ContactDetails/TelephoneSection/input_Home_oxd-input oxd-input--active'), homeNo_Contact)
...
WebUI.setText(findTestObject('Object Repository/MyInfo_Objects/ContactDetails/TelephoneSection/input_Mobile_oxd-input oxd-input--focus'), mobileNo_Contact)
...
WebUI.setText(findTestObject('Object Repository/MyInfo_Objects/ContactDetails/TelephoneSection/input_Work_oxd-input oxd-input--focus'), workNo_Contact)
