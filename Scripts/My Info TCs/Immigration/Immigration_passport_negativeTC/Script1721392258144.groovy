...
WebUI.verifyElementPresent(findTestObject('Object Repository/MyInfo_Objects/Immigration/passportNo_required'), 0)
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/MyInfo_Objects/Immigration/passportNo_required')), 'Required', false)
