...
WebUI.click(findTestObject('Object Repository/MyInfo_Objects/Dependents/EditBtn'))
...
WebUI.setText(findTestObject('Object Repository/MyInfo_Objects/Dependents/input_Date of Birth_oxd-input oxd-input--focus'), new_dob)
