 ...
 *  6. Verify that No Records Found message is shown
 */
...
// Verify that No Records Found message is shown
WebUI.verifyElementVisible(findTestObject('Object Repository/Studio Assist AI Obj Repo/Admin/No Records Found'))